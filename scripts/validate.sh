...
FAST_CHECKS=(structure marketplace-sync manifest-versions json yaml shell-syntax)
...
Run repository validation checks from scripts/checks/.
  --fast      Structure, marketplace sync, manifest versions, JSON, YAML, shell syntax (default).
